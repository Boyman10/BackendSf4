 ...
 */
class Version20180429095108 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE member (id INT AUTO_INCREMENT NOT NULL, role_id INT NOT NULL, pass VARCHAR(16) NOT NULL, username VARCHAR(50) NOT NULL, UNIQUE INDEX UNIQ_70E4FA78D60322AC (role_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE person (id INT AUTO_INCREMENT NOT NULL, member_id INT DEFAULT NULL, firstname VARCHAR(150) NOT NULL, lastname VARCHAR(150) NOT NULL, date_of_birth DATE NOT NULL, UNIQUE INDEX UNIQ_34DCD1767597D3FE (member_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
